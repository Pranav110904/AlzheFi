      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={modal.sheetWrapper}>
        <View style={modal.sheet}>
          ...
          <View style={styles.forPatientBanner}>
            ...
            <Text style={styles.forPatientText}>For <Text style={{ fontFamily: 'SpaceGrotesk-Bold' }}>{patientName}</Text></Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  patientSelectorLabel: { fontSize: 11, fontFamily: 'SpaceGrotesk-Regular', color: MUTED, textTransform: 'uppercase', letterSpacing: 1 },
...
const modal = StyleSheet.create({
  ...
  importanceLabel: { fontSize: 15, fontFamily: 'SpaceGrotesk-Bold', letterSpacing: 0.3 },
  importanceDesc: { fontSize: 10, fontFamily: 'SpaceGrotesk-Regular', color: MUTED, textAlign: 'center', lineHeight: 14 },
